...
List<Project> projectList = [
  Project(
    ...
    'GitHub User Info App, built with Flutter, empowers users to fetch comprehensive details about a GitHub user. Simply input the correct username to explore information like followers, following, bio, and a full repository list. A convenient tool for efficiently accessing GitHub user data.',
    'assets/images/github_user_info_app.png',
    'https://github.com/Naincy04/github-user-info-app',
  ),
  Project(
    'My Portfolio app',
    ...
    'https://github.com/Naincy04/portfolio',
  ),
  Project(
    'Flutter-FirebaseGram app',
  ...
  Project(
      'BMI calculator app',
      'The BMI Calculator App in Flutter is a handy tool for users seeking to monitor and manage their body mass index (BMI) in a straightforward and visually appealing manner. Featuring a clean and user-friendly design, the app allows users to input their weight and height, and instantly calculates their BMI based on the provided information.',
      'assets/images/to-do.png',
      'https://github.com/Naincy04/calculate_BMI_app'),
  Project(
      'URL shortener Website',
      'The URL Shortener Website is a powerful and efficient tool designed to simplify the process of shortening URLs for users. With a clean and intuitive interface, the website allows users to input long URLs and generate shortened links with a single click.',
      'assets/images/to-do.png',
      'Link'),
  Project(
      'Currency converter Website',
      'The Currency Converter Website is a versatile and user-friendly tool that enables users to convert currencies with ease. With a sleek and intuitive interface, the website allows users to select the desired currencies and input the amount to be converted. The website then displays the converted amount based on the latest exchange rates, providing users with accurate and up-to-date information.',
      'assets/images/to-do.png',
      'Link'),
];
